 ...
 * • `BOOKING_PUBLIC_BASE_URL` — public site origin for links in emails and signed `.ics` downloads (no trailing slash), e.g. `https://mentemaestra.studio`. Falls back to `VERCEL_URL` or `http://localhost:3000`.
