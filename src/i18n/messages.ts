...
export const messages = {
  es: {
    ...
    services: {
      title: "Servicios",
      cta: "Ver nuestro enfoque",
      branding: {
        title: "Branding",
        description:
          "Definimos tu posición, afilamos la narrativa y construimos identidad con claridad, confianza y un punto de vista memorable.",
      },
      design: {
        title: "Diseño",
        description:
          "Traducimos la estrategia en sistemas visuales, experiencias web y piezas que se sienten premium, coherentes y listas para escalar.",
      },
      code: {
        title: "Código",
        description:
          "Llevamos el diseño a sitios rápidos y pulidos, enfocados en conversión, con precisión y rendimiento.",
      },
      growth: {
        title: "Crecimiento",
        description:
          "Mantenemos el ritmo con optimización, soporte en lanzamientos e iteración creativa para que tu marca siga evolucionando.",
      },
    },
    marquee: {
      items: [
        "WEB, PRODUCTO Y MARCA",
        "DESARROLLO, UI/UX Y PROTOTIPOS",
        "CONTENIDO, VIDEO Y FOTOGRAFÍA",
        "PRESENCIA DIGITAL Y REDES — GESTIÓN COMPLETA",
        "TODAS TUS NECESIDADES DE DISEÑO, UNA SUSCRIPCIÓN",
        "SIN FREELANCES SUELTOS. SIN IDAS Y VUELTAS.",
        "MEJORAS Y ACTUALIZACIONES CONTINUAS",
        "DISEÑO, RESUELTO DE PUNTA A PUNTA",
      ],
    },
    featured: {
      label: "Proyectos destacados",
      magic:
        "Un diseño centrado en las personas impulsa productividad y resultados.",
      prev: "Anterior",
      next: "Siguiente",
    ...
    experience: {
      ...
      leftBody:
        "Un socio de diseño ágil para marcas que necesitan ritmo, coherencia y ejecución impecable en cada punto de contacto.",
      ...
      stat3Title: "Innovación y crecimiento como base.",
      stat3Body:
        "Invertimos en procesos, herramientas y relaciones que evolucionan para que cada proyecto gane en calidad creativa y en impacto con el tiempo.",
    },
    pricing: {
      sectionLabel: "Precios y modalidad",
      title: "Elige cómo quieres trabajar",
      subtitle:
        "Fácil de leer y de contratar: un entregable clave o un socio creativo bajo demanda.",
      ...
      subscriptionTiers: [
        ...
        },
        {
          ...
          name: "Studio",
          blurb:
            "Todo incluido con respuesta rápida. Pausa cuando quieras.",
          popular: true,
          priceOneTime: "",
          priceOneTimeLabel: "",
          priceOneTimeNote: "",
  ...
  en: {
    ...
    services: {
      ...
      branding: {
        title: "Branding",
        description:
          "We define your positioning, sharpen your story, and build a brand identity that gives your business clarity, confidence, and a point of view people remember.",
      },
      design: {
        title: "Design",
        description:
          "We translate strategy into high-impact visual systems, web experiences, and creative assets that make your brand feel premium, coherent, and ready to scale.",
      },
      code: {
        title: "Code",
        description:
          "We turn approved design into fast, polished, conversion-focused websites and digital touchpoints that bring the brand to life with precision and performance.",
      },
      growth: {
        title: "Growth",
        description:
          "We keep momentum high with ongoing optimization, launch support, and creative iteration so your brand keeps evolving, performing, and winning attention.",
      },
    },
    marquee: {
      items: [
    ...
    featured: {
      ...
      magicHighlights: ["user-centered", "revenue"],
      prev: "Prev Slide",
      next: "Next Slide",
    },
    stack: {
    ...
    experience: {
      ...
      leftBody:
        "A streamlined design partner for modern brands that need momentum, consistency, and sharp execution across every key touchpoint.",
      stat1Label: "Track record",
      stat1Title:
        "We help creative agencies, designers, and makers connect their craft with clients who value quality.",
      stat1Unit: "Years of\nexperience",
      stat2Label: "Shipped work",
      stat2Title:
        "A tight team of designers and developers focused on clear deliveries and measurable outcomes.",
      stat2Unit: "Projects\ncompleted",
      stat3Label: "Commitment",
      stat3Title: "Innovation and growth are non-negotiable.",
      stat3Body:
    ...
    pricing: {
      ...
      subtitle:
        "Simple to scan, straightforward to buy—whether you need one flagship deliverable or an on-demand creative partner.",
      ...
      subscriptionTiers: [
        ...
        },
        {
          ...
          name: "Studio",
          blurb:
            "Everything included with fast replies. Pause anytime.",
          popular: true,
          priceOneTime: "",
          priceOneTimeLabel: "",
          priceOneTimeNote: "",
