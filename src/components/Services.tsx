  ...
  return (
    <section id="services" className="px-6 py-24">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-10 flex flex-col gap-3 rounded-2xl border border-zinc-800/80 bg-zinc-900/30 p-6 md:flex-row md:items-center md:gap-6 md:p-7">
          <span className="w-fit rounded-full bg-accent/15 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.18em] text-accent">
            {s.addOnsLabel}
          </span>
