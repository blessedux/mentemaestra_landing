...
export function LandingFooter() {
  ...
  const handleSplineLoaded = () => {
    console.log("🎉 LandingFooter: Spline scene loaded successfully");
  };

  const handleSplineError = () => {
    console.error("❌ LandingFooter: Spline scene failed to load");
  };
  ...
  return (
    <footer className="relative w-full min-h-screen overflow-hidden bg-black">
      {/* Spline Scene */}
      <SplineScene
