    ...
    <section className="flex w-full justify-center px-4 pb-12 pt-28 md:px-6">
      ...
      >
        <div className="relative flex min-h-[560px] flex-col items-center justify-center overflow-hidden rounded-[48px] border border-border bg-[#120a06] shadow-sm duration-500 md:min-h-[600px]">
          <div
            className="pointer-events-none absolute inset-0 z-0 bg-gradient-to-br from-[#FF6500]/35 via-[#2a1810] to-[#0c0806]/90"
            aria-hidden
          />
          <Suspense
          ...
          <div className="relative z-10 mx-auto flex max-w-4xl flex-col items-center px-6 text-center">
            ...
            <h2 className="mb-4 text-5xl font-medium leading-[1.05] tracking-tight text-foreground md:text-7xl lg:text-8xl">
              Mente
              <br />
              <span className="text-foreground/80">Maestra</span>
            </h2>

            <p className="mb-4 max-w-2xl text-lg font-medium leading-snug tracking-tight text-zinc-300 md:text-xl">
              {t.hero.subtitle}
            </p>
