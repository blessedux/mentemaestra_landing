  ...
  return (
    <div>
      <Card className="gap-0 p-0">
        <CardHeader className="flex h-max justify-center border-b p-4 !p-4">
        ...
        <CardContent className="relative p-0 md:pr-48">
          ...
          <div className="inset-y-0 right-0 flex w-full max-md:h-60 flex-col gap-4 border-t md:absolute md:w-48 md:border-t-0 md:border-l">
